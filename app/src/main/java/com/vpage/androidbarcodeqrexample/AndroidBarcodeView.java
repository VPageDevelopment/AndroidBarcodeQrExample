...
{
    private static final String TAG = AndroidBarcodeView.class.getName();
	...
	private static void testCODABAR(Canvas canvas)
    {
    ...
    private static void testCODE11(Canvas canvas)
    {
    ...
    private static void testCODE2OF5(Canvas canvas)
    {
    ...
    private static void testCODE39(Canvas canvas)
    {
    ...
    private static void testCODE93(Canvas canvas)
    {
    ...
    private static void testEAN8(Canvas canvas)
    {
    ...
    private static void testEAN13(Canvas canvas)
    {
    ...
    private static void testISBN(Canvas canvas)
    {
    ...
    private static void testISSN(Canvas canvas)
    {
    ...
    private static void testITF14(Canvas canvas)
    {
    ...
    private static void testINTERLEAVED25(Canvas canvas)
    {
    ...
    private static void testIDENTCODE(Canvas canvas)
    {
    ...
    private static void testLEITCODE(Canvas canvas)
    {
    ...
    private static void testMSI(Canvas canvas)
    {
        MSI barcode = new MSI();
    ...
    private static void testONECODE(Canvas canvas)
    {
    ...
    private static void testPLANET(Canvas canvas)
    {
    ...
    private static void testPOSTNET(Canvas canvas)
    {
    ...
    private static void testRM4SCC(Canvas canvas)
    {
    ...
    private static void testUPCE(Canvas canvas)
    {
    ...
    private static void testCODE128(Canvas canvas)
    {
    ...
    private static void testEAN128(Canvas canvas)
    {
    ...
    private static void testDataMatrix(Canvas canvas)
    {
    ...
    private static void testPDF417(Canvas canvas)
    {
    ...
    private static void testQRCode(Canvas canvas)
    {
